<template>
    <div class="result">
        ...
        <div class="flex" v-if="!isLotteryDrawing && lotteryResult">
            <KlcLotteryBall v-for="(num, inx) of gameResult" :key="inx" :i="num" :blur="inx" :delay="inx + 1" :ball="28" :percent="-5" />
        </div>
...
import KlcLotteryBall from '@/components/public/KlcLotteryBall.vue';
