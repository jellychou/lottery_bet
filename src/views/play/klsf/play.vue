<template>
    <div class="relative flex">
        ...
        <div class="display h-full overflow-hidden">
            ...
            <div class="main_play" :style="{ height: rD.checkbox ? 'calc(100dvh - 480px)' : 'calc(100dvh - 375px)' }">
...
const rD = computed(() => {
    const agr = rodioIndex.value + hleper.value && play.value && lotteryItems.value && currentLottery.value.parentCode === 'klsf'; // 直接使用 lotteryData 作为依赖项
    let result = {};
    if (agr) {
        try {
