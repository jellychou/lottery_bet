<template>
    <div class="result">
        ...
        <div class="flex" v-if="!isLotteryDrawing && lotteryResult">
            <ThreeColorLotteryBall v-for="(num, inx) of gameResult" :key="inx" :i="num - 1" :blur="inx" :delay="inx + 1" :ball="20" :percent="-5" />
        </div>
...
import ThreeColorLotteryBall from '@/components/public/ThreeColorLotteryBall.vue';
...
const gameResult = computed(() => {
    ...
    return lotteryResult.value && arr.length === 8 ? arr : [0, 0, 0, 0, 0, 0, 0, 0];
});
</script>
