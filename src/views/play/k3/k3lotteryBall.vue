<template>
    <div class="scroll-num mt-4 mr-1" :style="{ '--i': props.i, '--delay': props.delay, '--percent': props.percent }">
        <ul ref="ulRef" :class="`ul_${props.i}`">
            <li class="ballItem relative" v-for="num in 6" :key="num">
                <img class="dice" v-if="props.i === 1" src="../assets/one.png" />
                <img class="dice" v-if="props.i === 2" src="../assets/two.png" />
                <img class="dice" v-if="props.i === 3" src="../assets/three.png" />
                <img class="dice" v-if="props.i === 4" src="../assets/four.png" />
                <img class="dice" v-if="props.i === 5" src="../assets/five.png" />
                <img class="dice" v-if="props.i === 6" src="../assets/six.png" />
            </li>
        </ul>
