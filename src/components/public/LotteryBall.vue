<template>
    <div v-if="props.delay === 7" class="line"></div>
    <div class="scroll-num mt-4 ml-1" :style="{ '--i': props.i, '--delay': props.delay, '--percent': props.percent }">
        <ul ref="ulRef" :class="`ul_${props.i}`">
            <li class="ballItem relative" v-for="num in ball" :key="num">
                <img v-if="props.delay === 7" class="absolute ball" src="./assets/ball/blueBall.png" />
                <img v-else class="absolute ball" src="./assets/ball/redBall.png" />
