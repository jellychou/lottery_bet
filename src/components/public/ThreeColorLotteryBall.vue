<template>
    <div class="scroll-num mt-4 ml-1" :style="{ '--i': props.i, '--delay': props.delay, '--percent': props.percent }">
        <ul ref="ulRef" :class="`ul_${props.i}`">
            <li class="ballItem relative" v-for="num in ball" :key="num">
                <img v-if="props.delay === 1 || props.delay === 4 || props.delay === 7" class="absolute ball" src="./assets/ball/redBall.png" />
                <img v-if="props.delay === 2 || props.delay === 5 || props.delay === 8" class="absolute ball" src="./assets/ball/blueBall.png" />
                <img v-if="props.delay === 3 || props.delay === 6 || props.delay === 0" class="absolute ball" src="./assets/ball/greenBall.png" />
